...
function Sidebar({sidebarOpen, setSidebarOpen, mobileMenuOpen, setMobileMenuOpen}) {
    ...
    const navigation = [
        ...
        { name: 'Structure',icon:<MdAccountTree size={20}/>, href: '#', current: false },
    ...
    <>
        ...
        <div className={`fixed inset-y-0 left-0 z-50 w-64 transform bg-white dark:bg-gray-800 transition-transform duration-300 ease-in-out lg:hidden ${
            ...
            <div className="flex h-16 items-center justify-between border-b border-gray-200 px-4 dark:border-gray-700">
                <ApplicationLogo logo_img="./logo_name_br.png" className="w-auto fill-current text-gray-800 dark:text-gray-200" />
                <button
